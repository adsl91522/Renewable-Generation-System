...
unsigned short ADR;
unsigned short Illuminance_Class;
...
volatile unsigned int TransmitData[25];
...
void main()
{
	...
	TransmitData[19]=Illuminance_Class;
...
/*		else if(ADR>(1241.212/2) && ADR<(3103.03/2))*/
		else if(ADR>780)
		{
			PortD_AllBitStatus=0x7f;
			Illuminance_Class=7;			
		}	
/*		else if(ADR>(620.606/2) && ADR<(1241.212/2))*/
		else if(ADR>680)
		{
			PortD_AllBitStatus=0x3f;
			Illuminance_Class=6;			
		}
/*		else if(ADR>(310.303/2) && ADR<(620.606/2))*/
		else if(ADR>580)
		{
			PortD_AllBitStatus=0x1f;
			Illuminance_Class=5;			
		}
/*		else if(ADR>(186.1818/2) && ADR<(310.303/2))*/
		else if(ADR>480)
		{
			PortD_AllBitStatus=0x0f;
			Illuminance_Class=4;			
		}
/*		else if(ADR>(124.1212/2) && ADR<(186.1818/2))*/
		else if(ADR>370)
		{
			PortD_AllBitStatus=0x07;
			Illuminance_Class=3;			
		}
/*		else if(ADR>(62.0606/2) && ADR<(124.1212/2))*/
		else if(ADR>250)
		{
			PortD_AllBitStatus=0x03;
			Illuminance_Class=2;			
		}
/*		else if(ADR>(37.236/2) && ADR<(62.0606/2))*/
		else if(ADR>=120)
		{
			PortD_AllBitStatus=0x01;
			Illuminance_Class=1;			
		}
/*		else if(ADR<(37.236/2))*/
		else if(ADR<120)
		{
			PortD_AllBitStatus=0x00;
			Illuminance_Class=0;			
		...
		TransmitData[18]=EedNumber;
		TransmitData[19]=Illuminance_Class;
//		TransmitData[18]=ADC_Ch4_LByte;
//		TransmitData[19]=ADC_Ch4_HByte;
		crc_cal();
		TransmitData[20]=crc;	
